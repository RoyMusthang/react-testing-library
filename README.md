...
1. Clone o repositório
  * `git clone https://github.com/tryber/sd-013-a-project-react-testing-library.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-013-a-project-react-testing-library`
...
6. Crie um novo `Pull Request` _(PR)_
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-013-a-project-react-testing-library/pulls) e confira que o seu _Pull Request_ está criado
